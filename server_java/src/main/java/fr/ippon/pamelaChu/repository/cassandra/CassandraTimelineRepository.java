...
import fr.ippon.pamelaChu.domain.status.Announcement;
import fr.ippon.pamelaChu.domain.status.Share;
import fr.ippon.pamelaChu.repository.TimelineRepository;
...
import static fr.ippon.pamelaChu.config.ColumnFamilyKeys.TIMELINE_CF;
import static fr.ippon.pamelaChu.config.ColumnFamilyKeys.TIMELINE_SHARES_CF;

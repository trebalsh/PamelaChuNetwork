 ...
 */
@Component
public class CassandraIdempotentRepository implements fr.ippon.pamelaChu.repository.IdempotentRepository {
    ...
    private final static String PAMELACHUBOT_DUPLICATE_CF = "PamelaChuBotDuplicate";
    ...
    public boolean add(String key) {
        if (contains(key)) {
            ...
            mutator.insert(KEY, PAMELACHUBOT_DUPLICATE_CF, column);
            return true;
        }
    }
    ...
    public boolean contains(String key) {
        ...
        HColumn<String, String> column =
                query.setColumnFamily(PAMELACHUBOT_DUPLICATE_CF)
                        .setKey(KEY)
                        .setName(key)
                        .execute()
                        .get();
    ...
    public boolean remove(String key) {
        ...
        mutator.delete(KEY, PAMELACHUBOT_DUPLICATE_CF, key, StringSerializer.get());
        return true;
    }

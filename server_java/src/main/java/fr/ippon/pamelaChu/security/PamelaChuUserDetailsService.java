...
public class PamelaChuUserDetailsService implements UserDetailsService {

    private final Logger log = LoggerFactory.getLogger(PamelaChuUserDetailsService.class);
    ...
    public void init() {
        if (userGrantedAuthorities.size() == 0) { // to prevent a bug that makes this bean initialized twice
            ...
            //Roles for "admin" users, configured in pamelaChu.properties
            ...
            String adminUsersList = env.getProperty("pamelaChu.admin.users");
    ...
    public UserDetails loadUserByUsername(final String login) throws UsernameNotFoundException {
        ...
        return getPamelaChuUserDetails(lowercaseLogin, userFromCassandra.getPassword());
    }

    protected org.springframework.security.core.userdetails.User getPamelaChuUserDetails(String login, String password) {

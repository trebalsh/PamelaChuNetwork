package fr.ippon.pamelaChu.security;
...
/**
 * PamelaChu specific LdapAuthenticationProvider.
 *
 * @author Julien Dubois
 */
public class PamelaChuLdapAuthenticationProvider extends LdapAuthenticationProvider {

    private final Logger log = LoggerFactory.getLogger(PamelaChuLdapAuthenticationProvider.class);
    ...
    @Inject
    private PamelaChuUserDetailsService userDetailsService; // => handles grantedAuthorities
    ...
    public PamelaChuLdapAuthenticationProvider(LdapAuthenticator authenticator, String managedDomain) {
        super(authenticator);
        if (StringUtils.isEmpty(managedDomain)) {
            throw new IllegalArgumentException("You must provide a managedDomain on this PamelaChuLdapAuthenticationProvider");
        }
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        //Automatically create LDAP users in PamelaChu
        ...
        org.springframework.security.core.userdetails.User realUser = userDetailsService.getPamelaChuUserDetails(login,

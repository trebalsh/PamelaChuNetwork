...
public class OpenIdAutoRegisteringUserDetailsService implements
    ...
    public UserDetails loadUserDetails(OpenIDAuthenticationToken token) throws UsernameNotFoundException {
        ...
        // Automatically create OpenId users in PamelaChu :
        ...
        try {
            ...
            log.info("User with login : \"{}\" doesn't exist yet in PamelaChu database - creating it...", login);
    ...
    private org.springframework.security.core.userdetails.User getNewlyCreatedUserDetails(OpenIDAuthenticationToken token) {
        ...
        return userDetailsService.getPamelaChuUserDetails(login, user.getPassword());
    }

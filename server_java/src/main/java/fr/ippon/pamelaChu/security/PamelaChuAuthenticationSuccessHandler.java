...
import fr.ippon.pamelaChu.repository.AppleDeviceRepository;
import fr.ippon.pamelaChu.repository.AppleDeviceUserRepository;
...
/**
 * PamelaChu specific Spring Security success handler, that understands Ajax requests.
 */
@Component
public class PamelaChuAuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {

    private final Logger log = LoggerFactory.getLogger(PamelaChuAuthenticationSuccessHandler.class);

...
public class ColumnFamilyKeys {
    ...
    public static final String PAMELACHUBOT_DUPLICATE_CF = "PamelaChuBotDuplicate";
    ...
    public static final String DOMAIN_PAMELACHUBOT_CF = "DomainPamelaChubot";

    public static final String PAMELACHUBOT_CONFIGURATION_CF = "PamelaChubotConfiguration";

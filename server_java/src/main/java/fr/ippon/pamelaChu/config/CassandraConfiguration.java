...
import static fr.ippon.pamelaChu.config.ColumnFamilyKeys.*;
...
public class CassandraConfiguration {
    ...
    public Keyspace keyspaceOperator() {
        ...
        if (keyspaceDef == null) {
            ...
            addColumnFamily(cluster, PAMELACHUBOT_CONFIGURATION_CF, 0);
            ...
            addColumnFamilySortedbyUUID(cluster, DOMAIN_PAMELACHUBOT_CF, 0);
            ...
            //PamelaChu Bot CF
            addColumnFamily(cluster, PAMELACHUBOT_DUPLICATE_CF, 0);
        }
    ...
    public EntityManagerImpl entityManager(Keyspace keyspace) {
        String[] packagesToScan = {"fr.ippon.pamelaChu.domain", "fr.ippon.pamelaChu.bot.config"};

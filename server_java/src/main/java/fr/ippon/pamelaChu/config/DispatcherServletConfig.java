...
import fr.ippon.pamelaChu.web.syndic.SyndicView;
...
@Configuration
@ComponentScan("fr.ippon.pamelaChu.web")
@EnableWebMvc
...
public class DispatcherServletConfig extends WebMvcConfigurerAdapter {
    ...
    public MessageSource messageSource() {
        ...
        if ("true".equals(env.getProperty("pamelaChu.message.reloading.enabled"))) {
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/static-wro4j/" + env.getProperty("pamelaChu.version") + "/**")
        ...
        registry.addResourceHandler("/static/" + env.getProperty("pamelaChu.version") + "/**")

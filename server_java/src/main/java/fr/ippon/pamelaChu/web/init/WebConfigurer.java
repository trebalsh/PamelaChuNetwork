package fr.ippon.pamelaChu.web.init;

import com.yammer.metrics.reporting.AdminServlet;
import com.yammer.metrics.web.DefaultWebappMetricsFilter;
import fr.ippon.pamelaChu.config.ApplicationConfiguration;
...
public class WebConfigurer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        dispatcherServlet.addMapping("/pamelaChu/*");
    ...
    private void initAtmosphereServlet(ServletContext servletContext) {
        ...
        atmosphereServlet.setInitParameter("org.atmosphere.cpr.packages", "fr.ippon.pamelaChu.web.atmosphere");

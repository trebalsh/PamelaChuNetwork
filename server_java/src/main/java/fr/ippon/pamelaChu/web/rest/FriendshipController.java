...
import fr.ippon.pamelaChu.service.FriendshipService;
...
public class FriendshipController {
    ...
    @Timed
    @ResponseBody
    public UserDTO updateFriend(@RequestBody fr.ippon.pamelaChu.web.rest.dto.UserActionStatus action, @PathVariable("username") String username) {

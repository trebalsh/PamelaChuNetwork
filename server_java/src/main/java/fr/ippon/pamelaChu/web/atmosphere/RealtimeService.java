...
public class RealtimeService extends OnMessage<PamelaChuNotification> {
    ...
    @Override
    public void onMessage(AtmosphereResponse response, PamelaChuNotification notification) throws IOException {

...
import fr.ippon.pamelaChu.repository.UserTagRepository;
import fr.ippon.pamelaChu.security.AuthenticationService;
import fr.ippon.pamelaChu.service.*;
...
import fr.ippon.pamelaChu.web.rest.dto.SearchResults;
...
public class SearchController {
    ...
    /**
     * GET  /search/all?q=pamelaChu -> search users, tags, groups for "pamelaChu"
     */
    ...
    /**
     * GET  /search/status?q=pamelaChu -> get the status where "pamelaChu" appears
     */

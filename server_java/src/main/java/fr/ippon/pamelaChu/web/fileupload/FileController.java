package fr.ippon.pamelaChu.web.fileupload;

import com.yammer.metrics.annotation.Timed;

import fr.ippon.pamelaChu.domain.Attachment;
import fr.ippon.pamelaChu.domain.Avatar;
import fr.ippon.pamelaChu.domain.User;
import fr.ippon.pamelaChu.repository.UserRepository;
import fr.ippon.pamelaChu.security.AuthenticationService;
import fr.ippon.pamelaChu.service.AttachmentService;
import fr.ippon.pamelaChu.service.AvatarService;
import fr.ippon.pamelaChu.service.UserService;
import fr.ippon.pamelaChu.service.exception.StorageSizeException;
...
public class FileController {
    ...
    @PostConstruct
    public void init() {
        this.pamelaChuUrl = env.getProperty("pamelaChu.url");
    }
    ...
    public void download(@PathVariable("attachmentId") String attachmentId,
        ...
        if (attachment == null) {
            ...
            response.sendRedirect("/pamelaChu/file/file_not_found");
        } else {
            // ETag support
    ...
    public List<UploadedFile> uploadAvatar(
        ...
        UploadedFile uploadedFile = new UploadedFile(
                ...
                pamelaChuUrl + "/pamelaChu/avatar/" + avatar.getAvatarId() + "/" + file.getOriginalFilename());

        log.info("Avatar url : {}/pamelaChu/avatar/{}/{}", pamelaChuUrl, avatar.getAvatarId(), file.getOriginalFilename());
    ...
    public List<UploadedFile> upload(@RequestParam("uploadFile") MultipartFile file)
        ...
        UploadedFile uploadedFile = new UploadedFile(
                ...
                file.getOriginalFilename(),
                Long.valueOf(file.getSize()).intValue(),
                pamelaChuUrl + "/pamelaChu/file/" + attachment.getAttachmentId() + "/" + file.getOriginalFilename());

...
import fr.ippon.pamelaChu.service.exception.ArchivedGroupException;
import fr.ippon.pamelaChu.service.exception.ReplyStatusException;
...
public class StatusUpdateService {
     ...
     * <p/>
     * The PamelaChu Bot is a specific use case : as it sends a lot of statuses, it may pollute the global trends,
    ...
    private void manageStatusTags(Status status, Group group) {
        ...
        while (m.find()) {
            ...
            if (tag != null && !tag.isEmpty() && !tag.contains("#")) {
                ...
                //Excludes the PamelaChu Bot from the global trend
                if (!status.getUsername().equals(Constants.PAMELACHUBOT_NAME)) {

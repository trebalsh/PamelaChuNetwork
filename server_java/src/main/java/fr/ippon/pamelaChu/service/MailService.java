...
import fr.ippon.pamelaChu.domain.status.Status;
...
public class MailService {
    ...
    private final String templateRoot = "/META-INF/pamelaChu/mails/";
    ...
    public void sendRegistrationEmail(String registrationKey, User user) {
        ...
        String registrationUrl = pamelaChuUrl + "/pamelaChu/register?key=" + registrationKey;
    ...
    public void sendInvitationEmail(String email, User user) {
        ...
        model.put("invitationUrl", pamelaChuUrl);
    ...
    public void sendLostPasswordEmail(String registrationKey, User user) {
        ...
        String url = pamelaChuUrl + "/pamelaChu/register?key=" + registrationKey;
    ...
    public void sendUserPrivateMessageEmail(User mentionnedUser, Status status) {
        ...
        String url = pamelaChuUrl + "/pamelaChu/home/status/" + status.getStatusId();
    ...
    public void sendDailyDigestEmail(User user, List<StatusDTO> statuses, int nbStatus,
        ...
        Map<String, Object> model = new HashMap<String, Object>();
        model.put("user", user);
        model.put("pamelaChuUrl", pamelaChuUrl + "/pamelaChu/");
    ...
    private void sendEmail(String email, String subject, String text) {
        if (host != null && !host.equals("")) {
            ...
            try {
                ...
                log.debug("Did you configure your SMTP settings in /META-INF/pamelaChu/pamelaChu.properties ?");
            }
        } else {
            log.debug("SMTP server is not configured in /META-INF/pamelaChu/pamelaChu.properties");
        }
    }

...
import fr.ippon.pamelaChu.domain.status.AbstractStatus;
import fr.ippon.pamelaChu.domain.status.Status;
import fr.ippon.pamelaChu.domain.status.StatusType;
import fr.ippon.pamelaChu.repository.DomainRepository;
import fr.ippon.pamelaChu.repository.StatusRepository;
...
import static fr.ippon.pamelaChu.config.ColumnFamilyKeys.STATUS_CF;
...
public class AdminService {
    ...
    public Map<String, String> getEnvProperties() {
        ...
        loadProperty(properties, "pamelaChu.version");
        loadProperty(properties, "pamelaChu.wro4j.enabled");
        loadProperty(properties, "pamelaChu.google.analytics.key");
        loadProperty(properties, "pamelaChu.message.reloading.enabled");

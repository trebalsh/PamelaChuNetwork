...
import fr.ippon.pamelaChu.repository.AttachmentRepository;
import fr.ippon.pamelaChu.repository.DomainConfigurationRepository;
import fr.ippon.pamelaChu.repository.UserAttachmentRepository;
...
public class AttachmentService {
    ...
    private byte[] computeThumbnail(Attachment attachment) {
    	...
    	String[] imagesExtensions = env.getProperty("pamelaChu.attachment.thumbnail.extensions").split(",");

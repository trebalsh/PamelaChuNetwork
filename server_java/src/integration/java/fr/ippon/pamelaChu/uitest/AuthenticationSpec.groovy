package fr.ippon.pamelaChu.uitest

import pages.*
import pages.google.*
import spock.lang.Shared
import fr.ippon.pamelaChu.test.support.LdapTestServer
import fr.ippon.pamelaChu.uitest.support.PamelaChuBaseGebSpec

class AuthenticationSpec extends PamelaChuBaseGebSpec {
	...
	def setupSpec() {
		// It only works if PamelaChu server is on the same host as the test ...
		// AND pamelaChu server points to localhost to reach the ldap server !
		// TODO : fix pamelaChu configuration !

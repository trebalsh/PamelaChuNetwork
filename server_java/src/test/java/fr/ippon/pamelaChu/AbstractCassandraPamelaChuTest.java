...
import fr.ippon.pamelaChu.test.application.ApplicationTestConfiguration;
import fr.ippon.pamelaChu.test.application.WebApplicationTestConfiguration;
...
public abstract class AbstractCassandraPamelaChuTest {
    ...
    public static void beforeClass() throws Exception {
        synchronized (lock) {
            if (!isInitialized) {
                ...
                String clusterName = "PamelaChu cluster";

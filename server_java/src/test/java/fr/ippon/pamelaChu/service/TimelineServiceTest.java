...
public class TimelineServiceTest extends AbstractCassandraPamelaChuTest {
    ...
    private void assertThatLineForUserWithStatusIsOk(String username, Collection<StatusDTO> status) {
        ...
        assertThat(firstStatus.getContent(), is("PamelaChu is an enterprise social network"));
        ...
        assertThat(secondStatus.getContent(), is("PamelaChu is fully Open Source"));

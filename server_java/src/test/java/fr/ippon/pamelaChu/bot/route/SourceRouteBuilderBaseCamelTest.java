...
public abstract class SourceRouteBuilderBaseCamelTest<T extends SourceRouteBuilderBase> extends CamelTestSupport {
    ...
    private PamelaChubotConfiguration botConfiguration;
    ...
    protected RouteBuilder[] createRouteBuilders() throws Exception {
        ...
        RouteBuilder commonRoutebuilder = new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from("direct:toPamelaChu").process(new Processor() {
                    @Override
...
//        sut = new RssRouteBuilder(); // spécifique ...
        ...
        sut.setPamelaChuBotLogin("bot@ippon.fr");
    ...
    public void shouldConformToSourceRouteBuilderBaseRequirements() throws Exception {
        ...
        assertThat(firstCamelMsg.getHeader("pamelaChubotConfiguration", PamelaChubotConfiguration.class), is(botConfiguration));

        // Question : is it specific to rss ?
        if (!disableDateHeaderTest) {
            assertThat(firstCamelMsg.getHeader("pamelaChubotLastUpdateDate", Date.class), is(notNullValue()));
        }
    ...
    protected abstract PamelaChubotConfiguration getBotConfiguration();
